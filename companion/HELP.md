# NovaStar Broadcast Switcher Module

This module provides comprehensive control for the **NovaStar DB4K** Broadcast Switcher from Companion/Stream Deck.

## Configuration

### Initial Setup

1. **IP Address**: Enter the IP address of your DB4K on the network.
...
- Verify the DB4K is powered on and reachable on the same network as Companion.
